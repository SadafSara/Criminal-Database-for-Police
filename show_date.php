  ...
  <body>
	<section id="header">
		<div class="row">
			...
			<div class="col-md-2" style="padding-top:15px;font-size:28px;color:navy;text-align:left ;font: Helvetica;"> XYZ Interpol </div>
			<div class="col-md-10" style="text-align: right;padding-top:20px">
				<a href="homepage.php" style="  cursor: pointer;font-size: 25px;color:navy"> Home </a>
        <a href="show_date1.php" style="cursor: pointer;margin-left: 20px;font-size: 25px;color:navy"> Back </a>
			</div>
		</div>
	</section>
		<div class="title" style="padding:10px; font-size:30px"> Records according to the entered date </div>
		<div style="margin-left:10%; margin-right:10%; margin-top:40px; margin-bottom:40px;text-align:center ">
      <div class="container">
        <section id="section4">
        ...
        <div class="col-md-2"style="font-family:Helvetica; color: navy;font-size:20px;font-weight: bolder; text-align:center;text-decoration:underline"> CRINIMAL NAME</div>
      ...
      if(isset($_POST['edate'])){
      	$u = $_POST['edate'];
      $sql = " SELECT DONE_BY.date,CRIME.type,DONE_BY.criminal_id,CRIMINAL.name,CRIMINAL.age,CRIMINAL.gender FROM CRIME INNER JOIN DONE_BY ON CRIME.id=DONE_BY.crime_id INNER JOIN CRIMINAL ON DONE_BY.criminal_id=CRIMINAL.id where date = '$u' ";
        ...
        <div class="row" style="padding:5px;">
          <div class="col-md-2" style="font-family:Helvetica;font-weight: bolder;text-align:center; color: navy;font-size:18px">  <?php echo $row["date"]; ?> </div>
          <div class="col-md-2" style="font-family:Helvetica;font-weight: bolder;font-size:18px;color: navy;text-align:center">  <?php echo $row["type"]; ?> </div>
